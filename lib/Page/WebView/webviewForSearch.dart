...
class WebViewForSearch extends StatefulWidget {
  String? icon, name, UrlLink;
  SocialModel? model;
  WebViewForSearch({Key? key, this.UrlLink, this.icon, this.name, this.model})
      : super(key: key);

  @override
  State<WebViewForSearch> createState() => _WebViewForSearchState();
}

class _WebViewForSearchState extends State<WebViewForSearch> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      bottomNavigationBar: _isBottomBannerAdLoaded
        ...
        overlayOpacity: 0.8,
              child: WebView(
                initialUrl: "${widget.model!.UrlLink}",
