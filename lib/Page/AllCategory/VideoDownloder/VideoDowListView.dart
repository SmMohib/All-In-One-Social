...
class VideoDowListView extends StatelessWidget {
  VideoDowListView({Key? key, this.UrlLink, this.icon, this.model, this.name})
      : super(key: key);
  String? icon, name;
  String? UrlLink;
  SocialModel? model;
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: ((context) => WebViewExample(
                                    model: videolink[index],
                                  ))));
                    },
                    child: Card(
                      child: ListTile(
                        title: Text(
                          '${videolink[index].name}',
                          style: text18(),
                        ),
