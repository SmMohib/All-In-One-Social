...
class WheatherListView extends StatelessWidget {
  WheatherListView({Key? key, this.UrlLink, this.icon, this.model, this.name})
      : super(key: key);
  String? icon, name;
  String? UrlLink;
  SocialModel? model;
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: ((context) => WebViewExample(
                                    model: weatherlink[index],
                                  ))));
                    },
                    child: Card(
                      child: ListTile(
                        title: Text(
                          '${weatherlink[index].name}',
                          style: text18(),
                        ),
                      ),
                    ),
