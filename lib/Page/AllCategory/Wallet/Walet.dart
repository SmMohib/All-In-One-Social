...
class WaltListView extends StatelessWidget {
  WaltListView({Key? key, this.UrlLink, this.icon, this.model, this.name})
      : super(key: key);
  String? icon, name;
  String? UrlLink;
  SocialModel? model;
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: ((context) => WebViewExample(
                                    model: walletlink[index],
                                  ))));
                    },
                    child: Card(
                      child: ListTile(
                        title: Text(
                          '${walletlink[index].name}',
                          style: text18(),
                        ),
