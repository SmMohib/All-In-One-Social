...
class BrowserListView extends StatelessWidget {
  BrowserListView({Key? key, this.UrlLink, this.icon, this.model, this.name})
      : super(key: key);
  String? icon, name;
  String? UrlLink;
  SocialModel? model;
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: ((context) => WebViewExample(
                                    model: browserlink[index],
                                  ))));
                    },
                    child: Card(
                      child: ListTile(
                        title: Text(
                          '${browserlink[index].name}',
                          style: text18(),
                        ),
                      ),
                    ),
